...
export default function Employeed() {
    return (
        ...
        <div className='row container-fluid' >
            ...
            <div className=' col-sm-10 p-3 align-content-center'>
                <div className='row badge-dark pl-4 ' style={{ background: '#D5691E' }}>
                    <h1 htmlFor="" className=''>Empleado</h1>
                </div>
                <div className='bg-dark p-3 form-group ml-3 mr-3'>
                    <form action="" className='row buscar form-group d-flex mt-2 justify-content-sm-start m-2 md-form form-sm active-pink-2 mt-2'>
                        <input type="text" className=' form-control-sm m-1 mr-3 col-sm-10 ' placeholder='Buscar' />
                    ...
                    <div className=' row card-employeed'>
                        ...
                        <div className='col-lg-7'>
                            ...
                            <div className='row'>
                                <div className='col-sm-2 pl-3 text-sistema'>
                                    ...
                                    <label htmlFor="" className=''> Sexo:</label>
                                </div>
                                <div className='col-sm-8 pl-5'>
                        ...
                        <div className='col-lg-2 text-center border border-darken-1 border-bottom-0 border-top-0 border-right-0'>
                            ...
                            <button className='degradado  border-0 w-75 m-1'>
                                ...
                                <label htmlFor="" className='col-sm-9 m-0 ml-2 border border-right-0 border-top-0 border-bottom-0'> Ver</label>
                            </button> <br />
                            <button className='degradado  border-0 w-75 m-1'>
                                <i className='col-sm-2 fa fa-pencil-alt '></i>
                                <label htmlFor="" className='col-sm-9 m-0 ml-2 border border-right-0 border-top-0 border-bottom-0'> Modificar</label>
                            </button> <br />
                            <button className='degradado  border-0 w-75 m-1'>
                                <i className='col-sm-2 fas fa-ban '></i>
                                <label htmlFor="" className='col-sm-9 m-0 ml-2 border border-right-0 border-top-0 border-bottom-0'> Dar baja</label>
                            </button> <br />
                            <button className='degradado  border-0 w-75 m-1'>
                                <i className='col-sm-2 fa fa-trash-alt '></i>
                                <label htmlFor="" className='col-sm-9 m-0 ml-2  border border-right-0 border-top-0 border-bottom-0'> Eliminar</label>
                            </button> <br />
                        </div>
                    </div>
                    <br />
