...
export default function UsiarioModal(props) {
    ...
    return (
        <div id='frmJustificacion' className='modal fade inputEmpleado' tabIndex='-1'>
                    ...
                    <div className='modal-body pt-0 '>
                        <form>
                            ...
                            <div className='form-group'>
                                ...
                                <label htmlFor='txtTiempo'>Código asistencia:</label>
                                <input
                                    id='txtTiempo'
                                    type='text'
                                    className='form-control'
                            ...
                            <div className='form-group'>
                                <i className='fa fa-exclamation-triangle pl-2'></i>
                                <label htmlFor='txtTiempo'>Fecha inasistencia:</label>
                                <input
                                    id='txtTiempo'
                                    type='text'
                                    className='form-control'
                            ...
                            <div className='form-group'>
                                <i className='fa fa-exclamation-triangle pl-2'></i>
                                <label htmlFor='txtTiempo'>Fecha justificación:</label>
                                <input
                                    id='txtTiempo'
                                    type='text' disabled
