...
export default function EmployeedForm() {
    return (
        <div className='  row  container-fluid' >
            ...
            <div className='col-sm-10 p-3 align-content-center inputEmpleado  ' >
                <div className='row badge-dark pl-4 ' style={{ background: '#D5691E' }}>
                    <h1 htmlFor="" className=''>Empleado</h1>
                </div>
                <form action="" className='bg-dark p-3 form-group ml-3 mr-3'  >
                        ...
                        <div className="row border-0 ">
                            ...
                            <div className="col-sm-4 pl-3 pr-3">
                                <div className=''>
                                    ...
                                    <br />
                                    <input type="text" maxLength='8' className='form-control ' style={{ width: '100%' }} />
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="" id="" className='form-control' style={{ width: '100%' }} />
                                </div>
                        ...
                        <div className="row border border-0 pb-2">
                            ...
                            <div className="col-sm-4 pl-3 pr-3">
                                <div>
                                    ...
                                    <select name="selectorC" id="selectorC" class="btn" className='form-control btn btn-outline-sistema' style={{ width: '100%' }} >
                            ...
                            <div className="col-sm-4 pl-3 pr-3">
                                <div className=''>
                                    ...
                                    <input type="email" name="" id="" className='form-control' style={{ width: '100%' }} />
                                </div>
                                <div>
                    ...
                    <div className="row border pb-2 mt-3 empleCard bg-light">
                        ...
                        <div className="col-sm-4 pl-3 pr-3">
                            ...
                            <div>
                                ...
                                <input type="checkbox" name="" id="" /> <label htmlFor=""> Sí</label>
                            </div>
                            <div>
