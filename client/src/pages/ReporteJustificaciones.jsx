...
export default function RJustificaciones() {
    ...
    const colums =["Código", "Fecha tardanza","Fecha justificación","Motivo","Dni", "Nombres", "Apellidos","Estado"];
                            ...
                            {data.justifications.map((j) => {
                                return (
                                    <tr key={j.id}>
                                        ...
                                        <td>{j.attendance.employee.lastname}</td>
                                        <td>{j.state ? "Vigente" : "No vigente"}</td> 
                                    </tr>    
                                );
                            })}
                        </tbody>
        ...
        <table class='table tablaDetalleHorario'>
            <thead class='thead-dark '>
                <tr>
                    ...
                    <th scope='col'>Fecha justificación</th>
